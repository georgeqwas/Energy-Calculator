...
Άνοιξε το `index.html` σε έναν browser (διπλό κλικ). Δεν χρειάζεται build.

## Δομή

```
index.html        # η εφαρμογή (single-file, χωρίς build)
data/
  tariffs.json        # τα τιμολόγια (canonical)
  tariffs.js          # window.TARIFFS = {...}  ← το φορτώνει το index.html
scraper/
